...
- `src/piChatController.ts` owns Tau chat orchestration; pure controller helpers for formatting, parsing, type guards, and error classification live under `src/controller/`.
