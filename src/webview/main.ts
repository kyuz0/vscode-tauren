...
let renderedViewMode: WebviewState['viewMode'] = state.viewMode;
...
function syncSessionLaneForStateChange(
  renderedMode: WebviewState['viewMode'],
...
function setSessionLane(lane: 'sessions' | 'tree', options: { jump: boolean }): void {
